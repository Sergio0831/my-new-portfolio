...
function A11y(e) {
	...
	function f(e) {
		...
		(a.pagination &&
			a.pagination.el &&
			(i === a.pagination.el || a.pagination.el.contains(e.target)) &&
			!e.target.matches(classesToSelector(a.params.pagination.bulletClass))) ||
			(a.navigation &&
				a.navigation.nextEl &&
			...
			a.navigation &&
				a.navigation.prevEl &&
				i === a.navigation.prevEl &&
				((a.isBeginning && !a.params.loop) || a.slidePrev(),
				a.isBeginning ? s(t.firstSlideMessage) : s(t.prevSlideMessage)),
			a.pagination &&
				i.matches(classesToSelector(a.params.pagination.bulletClass)) &&
				i.click());
	}
	function m() {
	...
	const E = (e, a, t) => {
		...
		y = (e) => {
			...
			const i = a.slides.indexOf(t) === a.activeIndex,
				n =
					...
					a.visibleSlides &&
					a.visibleSlides.includes(t);
			i ||
				n ||
				(e.sourceCapabilities && e.sourceCapabilities.firesTouchEvents) ||
				(a.isHorizontal() ? (a.el.scrollLeft = 0) : (a.el.scrollTop = 0),
				a.slideTo(a.slides.indexOf(t), 0));
		},
		M = () => {
			const e = a.params.a11y;
			e.itemRoleDescriptionMessage && d(a.slides, e.itemRoleDescriptionMessage),
				e.slideRole && c(a.slides, e.slideRole);
			const t = a.slides.length;
			e.slideLabelMessage &&
				a.slides.forEach((i, n) => {
					const s = a.params.loop
		...
		A = () => {
			...
			(c = s),
				...
				M();
			let { nextEl: g, prevEl: u } = a.navigation ? a.navigation : {};
			if (
				((g = r(g)),
				(u = r(u)),
				g && g.forEach((a) => E(a, s, e.nextSlideMessage)),
				u && u.forEach((a) => E(a, s, e.prevSlideMessage)),
				v())
			) {
				(Array.isArray(a.pagination.el)
					? a.pagination.el
					: [a.pagination.el]
				).forEach((e) => {
			...
			a.el.addEventListener('focus', y, !0),
				a.el.addEventListener('pointerdown', b, !0),
				a.el.addEventListener('pointerup', h, !0);
		};
	i('beforeInit', () => {
		(n = createElement('span', a.params.a11y.notificationClass)),
		...
		i('fromEdge toEdge afterInit lock unlock', () => {
			a.params.a11y.enabled &&
				(function () {
					...
					t && (a.isBeginning ? (g(t), l(t)) : (u(t), o(t))),
						e && (a.isEnd ? (g(e), l(e)) : (u(e), o(e)));
				})();
		}),
		i('paginationUpdate', () => {
			a.params.a11y.enabled &&
				(function () {
					const e = a.params.a11y;
					m() &&
						a.pagination.bullets.forEach((t) => {
							a.params.pagination.clickable &&
								...
								t.matches(
									classesToSelector(a.params.pagination.bulletActiveClass),
								)
		...
		i('destroy', () => {
			a.params.a11y.enabled &&
				(function () {
					...
					a.el.removeEventListener('focus', y, !0),
						a.el.removeEventListener('pointerdown', b, !0),
						a.el.removeEventListener('pointerup', h, !0);
				})();
		});
}
