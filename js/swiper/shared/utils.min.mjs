			...
			? ((o = s.transform || s.webkitTransform),
			  o.split(',').length > 6 &&
					(o = o
						...
						.map((e) => e.replace(',', '.'))
						.join(', ')),
			  (l = new n.WebKitCSSMatrix('none' === o ? '' : o)))
			: ((l =
					s.MozTransform ||
					s.OTransform ||
					s.MsTransform ||
	...
	for (let n = 1; n < arguments.length; n += 1) {
		...
		if (null != r && !isNode(r)) {
			...
			for (let t = 0, o = n.length; t < o; t += 1) {
				...
				void 0 !== l &&
					l.enumerable &&
					(isObject(e[o]) && isObject(r[o])
						? r[o].__swiper__
							? (e[o] = r[o])
							: extend(e[o], r[o])
						: !isObject(e[o]) && isObject(r[o])
						? ((e[o] = {}),
						  r[o].__swiper__ ? (e[o] = r[o]) : extend(e[o], r[o]))
						: (e[o] = r[o]));
			}
		}
	}
...
function animateCSSModeScroll(e) {
	...
	const c = n > l ? 'next' : 'prev',
		...
		u = () => {
			...
			let p = l + c * (n - l);
			if ((m(p, n) && (p = n), t.wrapperEl.scrollTo({ [r]: p }), m(p, n)))
				return (
...
function elementOffset(e) {
	...
	return { top: r.top + i - l, left: r.left + a - s };
}
